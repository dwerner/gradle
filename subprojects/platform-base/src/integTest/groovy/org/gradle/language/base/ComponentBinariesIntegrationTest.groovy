...
"""
        ...
        then:
        failure.assertHasCause("Exception thrown while executing model rule: binaries { ... } @ build.gradle line 63, column 5")
        failure.assertHasCause("Cannot create 'binaries.mylibMain' using creation rule 'mylibMain(CustomBinary) { ... } @ build.gradle line 64, column 9' as the rule 'ComponentModelBasePlugin.Rules#collectBinaries > put()' is already registered to create this model element.")
    }
