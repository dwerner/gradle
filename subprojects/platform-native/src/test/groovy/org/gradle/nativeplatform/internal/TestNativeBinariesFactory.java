...
public class TestNativeBinariesFactory {
    ...
    public static <T extends BaseBinarySpec> T create(Class<? extends BinarySpec> type, Class<T> implType, String name, ITaskFactory taskFactory, final MutableModelNode componentNode,
        ...
        T binary = BaseBinaryFixtures.create(type, implType, name, componentNode, taskFactory);
